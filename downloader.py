...
def main():
    ...
    parser.add_argument('--all', action='store_true', help='Download for all customers')
    parser.add_argument('--customer', type=str, help='Download for specific customer')
    ...
    if args.customer:
        # Convert customer name to match SharePoint format
        # The customer from SharePoint will be in the list_customers() output
        # For now, we pass it directly and let download_all_customers filter
        customers = [args.customer]
        print(f"[INFO] Filtering to customer: {args.customer}")
    elif args.all:
        ...
        customers = None
        print("[INFO] No customer specified, processing all customers")
